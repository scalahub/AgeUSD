...
import stablecoin.v1.StableCoin.{INF, maxReserveRatioPercent, minReserveRatioPercent, rcDefaultPrice}

private[v1] object BankContract {
  val minStorageRent = 10000000L

  lazy val oraclePoolNFT = "b662db51cf2dc39f110a021c2a31c74f0a1a18ffffbf73e8a051a7b8c0f09ebc"
  ...
  val ergoTree = kiosk.script.ScriptUtil.compile(env.toMap, script)
